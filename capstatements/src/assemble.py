#!/usr/bin/env python3
"""Assemble self-contained Visionblox capability statements (inline CSS, base64 fonts + logo)."""
import base64, pathlib, sys

ROOT = pathlib.Path(__file__).resolve().parent
OUT  = ROOT.parent
REPO = OUT.parent
FONTS = REPO / "cutsheets" / "src" / "fonts"
...
SHEETS = [
    ("VBX_CapStatement_HC_IT_v2",  "body_hc.html",  "Visionblox — Healthcare IT Capability Statement"),
    ("VBX_CapStatement_GEN_IT_v2", "body_gen.html", "Visionblox — IT Services Capability Statement"),
]
