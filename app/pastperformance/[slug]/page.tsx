            ...
            >
              <div>
                ...
                <p className="text-text-secondary">
                  Additional past performance in related domains.
                </p>
              </div>
        ...
        <div className="container-wide">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-display font-bold mb-4">
              Evaluating Visionblox for a specific requirement?
            </h2>
            <p className="text-text-secondary text-lg mb-8">
              We can provide PPQ documentation, CPARS-format narratives, and direct reference
