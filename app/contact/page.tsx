  ...
  return (
    <div className="min-h-screen pt-20">
      ...
      <section className="relative py-20 overflow-hidden">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-vbx-teal-tint rounded-full blur-[100px]" />
              ...
              >
                <Link href={path.href} className="block group">
                  <div className="bg-background-secondary rounded-2xl border border-[var(--vbx-navy-light)]/10 p-8 h-full hover:border-[var(--vbx-navy-light)]/20 transition-all duration-300 hover:translate-y-[-4px]">
                    ...
                    <div className="flex items-center gap-2 text-vbx-navy font-medium group-hover:gap-3 transition-all">
                      Start Inquiry
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <motion.div
                ...
                className="bg-background-primary rounded-xl border border-[var(--vbx-navy-light)]/10 p-6"
              >
                <div className="flex items-center gap-3 mb-4">
                  <div className="w-10 h-10 rounded-lg bg-vbx-teal-tint flex items-center justify-center">
                    <Mail className="w-5 h-5 text-vbx-navy" />
                  </div>
                ...
                <a
                  ...
                  className="text-vbx-navy hover:underline text-sm"
                >
              ...
              >
                <div className="flex items-center gap-3 mb-4">
                  <div className="w-10 h-10 rounded-lg bg-vbx-teal-tint flex items-center justify-center">
                    <Phone className="w-5 h-5 text-vbx-navy" />
                  </div>
              ...
              >
                <div className="flex items-center gap-3 mb-4">
                  <div className="w-10 h-10 rounded-lg bg-vbx-teal-tint flex items-center justify-center">
                    <Shield className="w-5 h-5 text-vbx-navy" />
                  </div>
                ...
                <div className="space-y-3">
                  <div>
                    ...
                    <p className="font-mono font-medium text-vbx-navy">{COMPANY.cageCode}</p>
                  </div>
                  <div>
                    <p className="text-sm text-text-tertiary">UEI</p>
                    <p className="font-mono font-medium text-vbx-navy">{COMPANY.uei}</p>
                  </div>
                </div>
              </motion.div>
            </div>
            ...
            >
              <div className="flex items-center gap-3 justify-center mb-6">
                <MapPin className="w-5 h-5 text-vbx-navy" />
              ...
              <div className="flex flex-wrap justify-center gap-4">
                {COMPANY.locations.map((location) => (
                  <div
                    key={location.city}
                    className="bg-background-primary rounded-lg border border-[var(--vbx-navy-light)]/10 px-4 py-2 text-sm"
                  >
                    <span className="text-text-primary">{location.city}</span>
                    {location.type === 'HQ' && (
                      <span className="ml-2 text-xs text-vbx-navy font-medium">(HQ)</span>
                    )}
                  </div>
                ))}
              </div>
