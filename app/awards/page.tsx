...
const AWARDS: Award[] = [
  {
    ...
    awarded: 'Notice of Intent to Award posted June 30, 2026',
    location: 'Statewide — Montana',
    color: '#F7B801',
    badge: 'STATE / SLED',
    scope:
      'Statewide master contract vehicle for artificial intelligence products and services procured by Montana state agencies. Visionblox LLC was named a successful offeror on both Track 1 and Track 2 of the solicitation.',
    highlights: [
      'Selected on both Track 1 and Track 2 of the solicitation',
      'Competitively evaluated field included Fortune 500 systems integrators and national AI firms',
